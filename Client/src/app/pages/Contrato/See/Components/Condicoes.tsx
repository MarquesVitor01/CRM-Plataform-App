      ...
      <div className="condicoes text-uppercase d-flex flex-column justify-content-between">
        ...
        <div className="">
          <p className="text-cond">
            {clientData.equipeSupervisor !== "rais"
            ...
            término do contrato. 6. LIMITAÇÕES DE RESPONSABILIDADE A G.MAPS
            CONTACT CENTER LTDA não se responsabiliza por alterações, suspensões
            ou bloqueios realizados diretamente pelo Google em perfis de
            empresas, tampouco por políticas ou critérios de indexação e
            ranqueamento definidos pela plataforma. O serviço contratado é de
            meio e não de resultado, ou seja, não há garantia de posicionamento
            específico na busca do Google Maps. 7. CONFIDENCIALIDADE E DADOS
            Todas as informações trocadas entre as partes serão tratadas com
            confidencialidade. Os dados fornecidos pelo CONTRATANTE serão
            utilizados apenas para fins de execução dos serviços contratados, em
            conformidade com a LGPD (Lei nº 13.709/2018). 8. RESCISÃO Este
            contrato poderá ser rescindido por qualquer das partes, a qualquer
            momento, mediante aviso prévio de 7 (sete) dias. Não haverá
            devolução de valores em caso de rescisão após o início da execução
            dos serviços, por se tratar de serviço personalizado. 9. FORO Fica
            eleito o foro da Comarca de São Paulo – SP para dirimir quaisquer
            dúvidas ou controvérsias oriundas deste termo. DECLARAÇÃO DE CIÊNCIA
            E ACEITE Declaro que li, compreendi e aceito integralmente os termos
            aqui expostos, ciente de que se trata de um serviço personalizado,
            com execução imediata, não aplicando-se o direito de arrependimento
