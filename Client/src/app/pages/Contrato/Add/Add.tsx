...
import { auth, db } from "../../../global/Config/firebase/firebaseConfig";
...
export const Add = () => {
  ...
  const [tipoDocumento] = useState("CPF");
    ...
    if (senha === senhaCorreta) {
      if (novoId) {
        ...
        const dadosAtualizados = {
          ...
          monitoriaConcluidaYes:
            form.equipeSupervisor === "equipe_antiga"
              ? true
              : form.monitoriaConcluidaYes,
        };
