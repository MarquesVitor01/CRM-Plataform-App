  ...
  const downloadPDF = () => {
    ...
    if (contratoElement && condicoesElement && bgInfosContrato) {
      ...
      html2pdf()
        ...
        .save()
        .then(() => {
          // Restaura os estilos originais após a geração do PDF
